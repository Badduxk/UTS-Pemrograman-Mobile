# 📱 OMNI - UTS Pemrograman Mobile

## 👨‍💻 Identitas Mahasiswa
**Nama:** Muhammad Reza Faishal  
**NIM:** 152023113  
...
## 🧩 Deskripsi Aplikasi
**OMNI** merupakan aplikasi berbasis **Flutter** yang dikembangkan untuk memenuhi tugas **Ujian Tengah Semester (UTS)** pada mata kuliah **Pemrograman Mobile**.

Aplikasi ini terdiri dari beberapa halaman utama, yaitu:
1. Splash Screen  
2. Dashboard  
3. Biodata  
4. Kontak  
...
Aplikasi menerapkan konsep **Fragment/Page**, menggunakan **Bottom Navigation Bar** sebagai navigasi utama, dan menampilkan desain **UI/UX sederhana namun interaktif**.
...
- Konsep : **Fragment & Stateful Widget**
